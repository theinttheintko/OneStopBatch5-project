...
public class Jwt {
    ...
    public static Jwt from(String token, String securityKey) {
    ...
    public static Jwt of(Long userId, long validInMinutes, String securityKey) {
        ...
        var expiration = issuedDate.plus(validInMinutes, ChronoUnit.MINUTES);
        return new Jwt(
                Jwts.builder().claim("user_id", userId)
                        ...
                        .compact(),
                userId, LocalDateTime.ofInstant(issuedDate, ZoneId.systemDefault()),
